...
<?php
    if (isset($_GET['edit'])) {
		$id = $_GET['edit'];
		$record = pg_connect($conn, "SELECT * FROM product WHERE ProductID=$id");
...
<?php 
    if (isset($_POST['update'])) {
        ...
        pg_connect($conn, "UPDATE product SET Name='$updatedName', QtyInStock='$updatedQuantity', Price='$updatedPrice' WHERE ProductID=$id");
